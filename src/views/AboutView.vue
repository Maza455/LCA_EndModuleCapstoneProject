<template>
  <div>
    <div class="progress-container" id="progressContainer" style="top: -50px;">
      <div class="progress-bar" id="progressBar" style="background: rgba(67, 67, 163, 0.5);"></div>
    </div>

    <div class="aboutUsContentContainer aboutUsContent">
      <div class="aboutUsBanner" style="text-align: center; position: relative;">
        <img class="img-sz"
          src="https://i.postimg.cc/dVGSv6Xf/360-F-508801991-UTs-CAOorx25-USitqonf-RADue-Jlzyjh-Dq.jpg"
          style="height: 200px; width: 100%;">
        <div class="head-sz"
          style="font-weight: bold; font-size: 50px; color: black; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-shadow: 2px 2px rgb(67, 67, 163);">
          About
        </div>
      </div>
      ...
      <div class="w3-container w3-center DescContainerLeft" id="slideLeft"
        ...
        <p class="mid3-sz" style="text-align: center; margin-top: 50px; color: rgb(128, 128, 128);">ZukisaMaza
          ...
          an amazing experience, we haven’t done our job. We don’t measure success through achievements or
          awards, but through the satisfaction of our customers.</p>
      </div>
      ...
      <div class="w3-container w3-center DescContainerRight" id="slideRight"
        ...
        <p class="mid3-sz" style="text-align: center; margin-top: 50px; color: rgb(128, 128, 128);">In
          ...
          be delivered right to your doorstep. We guarantee on-time delivery and the best quality! Shopping
          online is now easy as every product on your shopping list is available at ZukisaMaza.com</p>
      </div>

      <h2 class="mid4-sz" style="text-align: center;">--What I Provide--</h2>

      <div class="flip-card-Container" style="margin-right: auto; margin-left: auto; width: fit-content;">
        <!-- Flip card components here -->
      </div>
    </div>
  </div>
</template>
