...
const auth = {
    ...
    mutations: {
        initialize(state) {
            ...
            if (accessToken) {
                ...
                state.data.firstName = decoded.firstName;
                state.data.emailAdd = decoded.emailAdd;
            } else {
                state.logged = false;
                state.isAdmin = false;
            }
    ...
    actions: {
        async loggedIn({
            ...
            commit("initialize");
            await dispatch("cart/save", null, {
                root: true
            });
            await dispatch("cart/get", null, {
                root: true
            });
        },
