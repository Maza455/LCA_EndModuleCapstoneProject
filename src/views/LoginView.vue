        ...
        <div class="row justify-content-center">
            <div class="col-md-4 border p-4 me-md-4 mb-4">
                ...
                <form @submit.prevent="login(user)" class="text-center row g-3">
                    <div>
                        <input v-model="user.emailAdd" type="text" class="form-control" placeholder="Email"
                            aria-describedby="email" required />
                    </div>
                    <div>
                        <input v-model="user.userPwd" type="password" class="form-control" placeholder="Password"
                            aria-describedby="password" required />
                    </div>
                    <div>
                        <input class="btn btn-success text-dark text-uppercase" type="submit" value="Sign in" />
                    </div>
            ...
            <div class="col-md-4 border p-4 mb-4">
                ...
                <router-link to="/account/register" class="btn btn-success text-dark text-uppercase">
                    Create an account
                </router-link>
            </div>
        </div>
